...
/**
 * This is an array backed implementation of FImmutableSortedDictionary. It uses
 * arrays and linear lookups to achieve good memory efficiency while maintaining
 * good performance for small collections. It also uses less allocations than a
 * comparable red black tree. To avoid degrading performance with increasing
 * collection size it will automatically convert to a FTreeSortedDictionary
