...
/**
 * The size threshold where we use a tree backed sorted map instead of an array
 * backed sorted map. This is a more or less arbitrary chosen value, that was
 * chosen to be large enough to fit most of object kind of Firebase data, but
 * small enough to not notice degradation in performance for inserting and
 * lookups. Feel free to empirically determine this constant, but don't expect
 * much gain in real world performance.
 */
