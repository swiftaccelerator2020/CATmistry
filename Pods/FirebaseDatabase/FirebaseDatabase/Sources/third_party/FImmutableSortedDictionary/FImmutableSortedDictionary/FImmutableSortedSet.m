...
+ (FImmutableSortedSet *)setWithKeysFromDictionary:(NSDictionary *)dictionary
    comparator:(NSComparator)comparator {
    FImmutableSortedDictionary *setDict =
        [FImmutableSortedDictionary fromDictionary:dictionary
...
- (FImmutableSortedSet *)addObject:(id)object {
    FImmutableSortedDictionary *newDictionary =
        [self.dictionary insertKey:object withValue:[NSNull null]];
...
- (void)enumerateObjectsReverse:(BOOL)reverse
    ...
    [self.dictionary
     enumerateKeysAndObjectsReverse:reverse
