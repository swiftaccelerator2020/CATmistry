...
#define _gdt_cct_NetworkConnectionInfo_NetworkType_ARRAYSIZE                   \
  ((gdt_cct_NetworkConnectionInfo_NetworkType)(                                \
...
#define _gdt_cct_NetworkConnectionInfo_MobileSubtype_MAX                       \
  gdt_cct_NetworkConnectionInfo_MobileSubtype_COMBINED
...
#define _gdt_cct_ClientInfo_ClientType_MAX                                     \
  gdt_cct_ClientInfo_ClientType_IOS_FIREBASE
#define _gdt_cct_ClientInfo_ClientType_ARRAYSIZE                               \
  ((gdt_cct_ClientInfo_ClientType)(                                            \
...
#define _gdt_cct_QosTierConfiguration_QosTier_MAX                              \
  gdt_cct_QosTierConfiguration_QosTier_NEVER
#define _gdt_cct_QosTierConfiguration_QosTier_ARRAYSIZE                        \
  ((gdt_cct_QosTierConfiguration_QosTier)(                                     \
      gdt_cct_QosTierConfiguration_QosTier_NEVER + 1))
...
#define gdt_cct_LogEvent_init_default                                          \
  {                                                                            \
    false, 0, NULL, false, 0, false, 0, false, 0, false,                       \
        gdt_cct_NetworkConnectionInfo_init_default                             \
  }
#define gdt_cct_NetworkConnectionInfo_init_default                             \
  {                                                                            \
    false, gdt_cct_NetworkConnectionInfo_NetworkType_NONE, false,              \
        gdt_cct_NetworkConnectionInfo_MobileSubtype_UNKNOWN_MOBILE_SUBTYPE     \
  }
#define gdt_cct_IosClientInfo_init_default                                     \
  { NULL, NULL, NULL, NULL, NULL, NULL, NULL }
#define gdt_cct_ClientInfo_init_default                                        \
  {                                                                            \
    false, _gdt_cct_ClientInfo_ClientType_MIN, false,                          \
        gdt_cct_IosClientInfo_init_default                                     \
  }
#define gdt_cct_BatchedLogRequest_init_default                                 \
  { 0, NULL }
#define gdt_cct_LogRequest_init_default                                        \
  {                                                                            \
    false, gdt_cct_ClientInfo_init_default, false, 0, 0, NULL, false, 0,       \
        false, 0, false, gdt_cct_QosTierConfiguration_QosTier_DEFAULT          \
  }
#define gdt_cct_QosTierConfiguration_init_default                              \
  { false, _gdt_cct_QosTierConfiguration_QosTier_MIN, false, 0 }
#define gdt_cct_QosTiersOverride_init_default                                  \
  { 0, NULL, false, 0 }
#define gdt_cct_LogResponse_init_default                                       \
  { false, 0, false, gdt_cct_QosTiersOverride_init_default }
#define gdt_cct_LogEvent_init_zero                                             \
  {                                                                            \
    false, 0, NULL, false, 0, false, 0, false, 0, false,                       \
        gdt_cct_NetworkConnectionInfo_init_zero                                \
  }
#define gdt_cct_NetworkConnectionInfo_init_zero                                \
  {                                                                            \
    false, _gdt_cct_NetworkConnectionInfo_NetworkType_MIN, false,              \
        _gdt_cct_NetworkConnectionInfo_MobileSubtype_MIN                       \
  }
#define gdt_cct_IosClientInfo_init_zero                                        \
  { NULL, NULL, NULL, NULL, NULL, NULL, NULL }
#define gdt_cct_ClientInfo_init_zero                                           \
  {                                                                            \
    false, _gdt_cct_ClientInfo_ClientType_MIN, false,                          \
        gdt_cct_IosClientInfo_init_zero                                        \
  }
#define gdt_cct_BatchedLogRequest_init_zero                                    \
  { 0, NULL }
#define gdt_cct_LogRequest_init_zero                                           \
  {                                                                            \
    false, gdt_cct_ClientInfo_init_zero, false, 0, 0, NULL, false, 0, false,   \
        0, false, _gdt_cct_QosTierConfiguration_QosTier_MIN                    \
  }
#define gdt_cct_QosTierConfiguration_init_zero                                 \
  { false, _gdt_cct_QosTierConfiguration_QosTier_MIN, false, 0 }
#define gdt_cct_QosTiersOverride_init_zero                                     \
  { 0, NULL, false, 0 }
#define gdt_cct_LogResponse_init_zero                                          \
  { false, 0, false, gdt_cct_QosTiersOverride_init_zero }
