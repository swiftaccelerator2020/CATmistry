...
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType_MIN     \
  logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType_UNKNOWN_CONFIGURATION_TYPE
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType_MAX     \
  logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType_SDK
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType_ARRAYSIZE \
  ((logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType)(              \
...
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_BuildType_MAX             \
  logs_proto_mobilesdk_ios_ICoreConfiguration_BuildType_PROD
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_BuildType_ARRAYSIZE       \
  ((logs_proto_mobilesdk_ios_ICoreConfiguration_BuildType)(                    \
...
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_ServiceType_MIN           \
  logs_proto_mobilesdk_ios_ICoreConfiguration_ServiceType_UNKNOWN_SDK_SERVICE
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_ServiceType_MAX           \
  logs_proto_mobilesdk_ios_ICoreConfiguration_ServiceType_ML_VISION_ON_DEVICE_OBJECT_DETECTION
...
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_PodName_MAX               \
  logs_proto_mobilesdk_ios_ICoreConfiguration_PodName_FIREBASE
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_PodName_ARRAYSIZE         \
  ((logs_proto_mobilesdk_ios_ICoreConfiguration_PodName)(                      \
...
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_DeploymentType_MAX        \
  logs_proto_mobilesdk_ios_ICoreConfiguration_DeploymentType_SPM
#define _logs_proto_mobilesdk_ios_ICoreConfiguration_DeploymentType_ARRAYSIZE  \
  ((logs_proto_mobilesdk_ios_ICoreConfiguration_DeploymentType)(               \
      logs_proto_mobilesdk_ios_ICoreConfiguration_DeploymentType_SPM + 1))
...
#define logs_proto_mobilesdk_ios_ICoreConfiguration_init_default               \
  {                                                                            \
    false, _logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType_MIN, \
        0, NULL, NULL, NULL, NULL, false,                                      \
        _logs_proto_mobilesdk_ios_ICoreConfiguration_PodName_MIN, NULL, NULL,  \
        false, _logs_proto_mobilesdk_ios_ICoreConfiguration_ServiceType_MIN,   \
        false, 0, NULL, NULL, false, 0, false, 0, false, 0, NULL, false, 0,    \
        false,                                                                 \
        _logs_proto_mobilesdk_ios_ICoreConfiguration_DeploymentType_MIN, NULL, \
        false, 0, false, 0                                                     \
  }
#define logs_proto_mobilesdk_ios_ICoreConfiguration_init_zero                  \
  {                                                                            \
    false, _logs_proto_mobilesdk_ios_ICoreConfiguration_ConfigurationType_MIN, \
        0, NULL, NULL, NULL, NULL, false,                                      \
        _logs_proto_mobilesdk_ios_ICoreConfiguration_PodName_MIN, NULL, NULL,  \
...
#define logs_proto_mobilesdk_ios_ICoreConfiguration_min_supported_ios_version_tag \
  24
...
#define logs_proto_mobilesdk_ios_ICoreConfiguration_dynamic_framework_count_tag \
  27
#define logs_proto_mobilesdk_ios_ICoreConfiguration_apple_framework_version_tag \
  28
...
/* logs_proto_mobilesdk_ios_ICoreConfiguration_size depends on runtime
 * parameters */
