...
/// associate up to 25 unique parameters with each Event type. Some common
/// events are suggested below, but you may also choose to specify custom Event
/// types that are associated with your specific app. Each event type is
/// identified by a unique name. Event names can be up to 40 characters long,
/// may only contain alphanumeric characters and underscores ("_"), and must
/// start with an alphabetic character. The "firebase_", "google_", and "ga_"
...
/// payment information. Note: If you supply the @c kFIRParameterValue
/// parameter, you must also supply the
/// @c kFIRParameterCurrency parameter so that revenue metrics can be computed
/// accurately. Params:
///
/// <ul>
...
/// to gauge the effectiveness of your checkout process. Note: If you supply the
/// @c kFIRParameterValue parameter, you must also supply the @c
/// kFIRParameterCurrency parameter so that revenue metrics can be computed
/// accurately. Params:
///
/// <ul>
///     <li>@c kFIRParameterCurrency (NSString) (optional)</li>
...
/// you supply the @c kFIRParameterValue parameter, you must also supply the @c
/// kFIRParameterCurrency parameter so that revenue metrics can be computed
/// accurately. Params:
///
/// <ul>
...
/// kFIREventPurchase event to gauge the effectiveness of your checkout process.
/// Note: If you supply the @c kFIRParameterValue parameter, you must also
/// supply the @c kFIRParameterCurrency parameter so that revenue metrics can be
...
/// parameters kFIRParameterSource, kFIRParameterMedium or
/// kFIRParameterCampaign. Params:
///
/// <ul>
...
///
/// <ul>
///    <li>@c kFIRParameterCheckoutStep (unsigned 64-bit integer as
///    NSNumber)</li> <li>@c kFIRParameterCheckoutOption (NSString)
///    (optional)</li>
/// </ul>
...
///     <li>@c kFIRParameterValue (signed 64-bit integer or double as
///     NSNumber)</li>
/// </ul>
...
/// reported automatically for App Store-based apps. Note: If you supply the @c
/// kFIRParameterValue parameter, you must also supply the @c
/// kFIRParameterCurrency parameter so that revenue metrics can be computed
/// accurately. Params:
///
/// <ul>
...
///     <li>@c kFIRParameterNumberOfNights (signed 64-bit integer as NSNumber)
///     (optional) for
///         hotel bookings</li>
///     <li>@c kFIRParameterNumberOfRooms (signed 64-bit integer as NSNumber)
///     (optional) for
///         hotel bookings</li>
///     <li>@c kFIRParameterNumberOfPassengers (signed 64-bit integer as
///     NSNumber) (optional)
///         for travel bookings</li>
///     <li>@c kFIRParameterOrigin (NSString) (optional)</li>
///     <li>@c kFIRParameterDestination (NSString) (optional)</li>
///     <li>@c kFIRParameterTravelClass (NSString) (optional) for travel
///     bookings</li>
/// </ul>
...
/// your game and it can help you correlate high scores with certain audiences
/// or behaviors. Params:
///
/// <ul>
///     <li>@c kFIRParameterScore (signed 64-bit integer as NSNumber)</li>
///     <li>@c kFIRParameterLevel (signed 64-bit integer as NSNumber)
...
/// kFIREventAddToCart and kFIREventEcommercePurchase to gauge your conversion
/// process. Note: If you supply the @c kFIRParameterValue parameter, you must
/// also supply the @c kFIRParameterCurrency parameter so that revenue metrics
...
/// parameter, you must also supply the @c kFIRParameterCurrency parameter so
...
/// automatic screen tracking is enabled. Params:
///
/// <ul>
...
/// parameters. This event can help you identify the most popular content in
/// your app. Params:
///
/// <ul>
...
/// <ul>
///    <li>@c kFIRParameterCheckoutStep (unsigned 64-bit integer as
///    NSNumber)</li> <li>@c kFIRParameterCheckoutOption (NSString)</li>
/// </ul>
/// <b>This constant has been deprecated.</b>
...
///     NSNumber)</li>
/// </ul>
static NSString *const kFIREventSpendVirtualCurrency NS_SWIFT_NAME(
    AnalyticsEventSpendVirtualCurrency) = @"spend_virtual_currency";

/// Tutorial Begin event. This event signifies the start of the on-boarding
/// process in your app. Use this in a funnel with kFIREventTutorialComplete to
...
/// @c kFIRParameterValue parameter, you must also supply the
/// @c kFIRParameterCurrency parameter so that revenue metrics can be computed
/// accurately. Params:
///
/// <ul>
...
/// which is reported automatically for App Store-based apps. Note: If you
/// supply the @c kFIRParameterValue parameter, you must also supply the @c
/// kFIRParameterCurrency parameter so that revenue metrics can be computed
/// accurately. Params:
///
/// <ul>
...
/// the @c kFIRParameterValue parameter, you must also supply the @c
/// kFIRParameterCurrency parameter so that revenue metrics can be computed
/// accurately. Params:
///
/// <ul>
...
/// kFIREventPurchase to gauge your conversion process. Params:
///
/// <ul>
///     <li>@c kFIRParameterCreativeName (NSString) (optional)</li>
///     <li>@c kFIRParameterCreativeSlot (NSString) (optional)</li>
