...
class PlayRetrieveSolidsDetailsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet var seperationTableView: UITableView!
    @IBOutlet var choicesTableView: UITableView!
    @IBOutlet var selectedChoiceLabel: UIButton!
    @IBOutlet var isWrong: UILabel!
    ...
    override func viewDidLoad() {
        ...
        seperationTableView.tableFooterView = UIView()
        choicesTableView.dataSource = self
        choicesTableView.delegate = self
        choicesTableView.allowsSelection = true
        choicesTableView.tableFooterView = UIView()
        ...
        if hardMode {
            progressBarTimer = Timer.scheduledTimer(timeInterval: 2, target: self, selector: #selector(PlayRetrieveSolidsDetailsViewController.updateProgressView), userInfo: nil, repeats: true)
        }
