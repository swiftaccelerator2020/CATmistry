...
var learnTopics = [
    ...
    Topic(title: "Separation Methods", pic: "separation-methods.png", pointsNeeded: 10, subTopics: [
        SubTopic(title: "What is Separation?", pic: "separation-methods.png", needSlider: false, content: SubContent(definition: "Separation process: \nMethod that converts a mixture/solution of chemical substances into 2 or more mixtures \n\nSeparation exploits differences in chemical properties or physical properties between the parts of a mixture, such as: \n- Size \n- Shape \n- Mass \n- Density \n- Magnetic Conductivity"), subTopics: [
            ...
            SubSubTopic(topic: "Distillation", picture: "distillation.png", id: 2, content: SubSubContent(image: "distillation.png", firstAttributionText: "Separates: Two or more miscible liquids", secondAttributionText: "Properties Involed: Difference of boiling points of Liquids", thirdAttributionText: "Principle of Separation: The liquid with the lower boiling point will distill first")),
            SubSubTopic(topic: "Filtration", picture: "filtration.png", id: 3, content: SubSubContent(image: "filtration.png", firstAttributionText: "Separates: Insoluble solid from solid-liquid mixture", secondAttributionText: "Properties Involed: Size of particles - small particle size", thirdAttributionText: "Principle of Separation: Filter paper prevents large particles from passing through")),
            SubSubTopic(topic: "Magnetism", picture: "magnetism.png", id: 4, content: SubSubContent(image: "magnetism.png", firstAttributionText: "Separates: Magnetic solid from solid-solid mixture", secondAttributionText: "Properties Involed: Magnetism", thirdAttributionText: "Principle of Separation: Magnetic solid will be attracted to the magnet")),
            SubSubTopic(topic: "Crystallisation", picture: "crystallisation.png", id: 5, content: SubSubContent(image: "crystallisation.png", firstAttributionText: "Separates: Soluble solid from solid-liquid mixture", secondAttributionText: "Properties Involed: Solubility changes with temperature", thirdAttributionText: "Principle of Separation: When the solubility of the solid decreases as the temperature of the mixture decreases, the solids that cannot be dissolved will crystallise"))
        ], navTitle: "Separation"),
        SubTopic(title: "Take the Quiz", pic: "quiz.png", needSlider: false, content: SubContent(definition: ""), subTopics: [], navTitle: "Take the Quiz")
...
var phGameOptionsArray = [
    PhOption(name: "Stomach Acid", image: "ph-1.png", turnTankColour: "monster-red.png"),
    PhOption(name: "Lemonade", image: "ph-2.png", turnTankColour: "monster-red.png"),
    PhOption(name: "Apple Juice", image: "ph-3.png", turnTankColour: "monster-red.png"),
    PhOption(name: "Tomato Juice", image: "ph-4.png", turnTankColour: "monster-red.png"),
    PhOption(name: "Coffee", image: "ph-5.png", turnTankColour: "monster-red.png"),
    PhOption(name: "Milk", image: "ph-6.png", turnTankColour: "monster-red.png"),
    PhOption(name: "Water", image: "ph-7", turnTankColour: "monster-green.png"),
    PhOption(name: "Egg", image: "ph-8.png", turnTankColour: "monster-purple.png"),
    PhOption(name: "Baking Soda", image: "ph-9.png", turnTankColour: "monster-purple.png"),
    PhOption(name: "Stomach Tablets", image: "ph-10.png", turnTankColour: "monster-purple.png"),
    PhOption(name: "Ammonia", image: "ph-11.png", turnTankColour: "monster-purple.png"),
    PhOption(name: "Soap", image: "ph-12.png", turnTankColour: "monster-purple.png"),
    PhOption(name: "Bleach", image: "ph-13.png", turnTankColour: "monster-purple.png"),
    PhOption(name: "Pipe Cleaner", image: "ph-14.png", turnTankColour: "monster-purple.png"),
]
