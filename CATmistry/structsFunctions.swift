...
var learnTopics = [
    ...
    Topic(title: "Periodic Table", pic: "periodic-table.png", pointsNeeded: 30, subTopics: [
        ...
        SubTopic(title: "First 18 Elements", pic: "elements.png", needSlider: false, content: SubContent(definition: "The periodic table is made up of more than 18 elements, but the first 18 are the easiest to understand and are the most basic ones that you will need to know. Explore the first 18 elements and learn about their charecteristics by clicking below!"), subTopics: [
